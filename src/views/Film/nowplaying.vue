...
export default {
  ...
  activated() {
    // this.height = document.documentElement.clientHeight - 149 + 'px'
  ...
  methods: {
    ...
    loadMore() {
      ...
      axios({
        url: `https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=${this.current}&pageSize=10&type=1&k=6395640`,
        headers: {
          'X-Client-Info': '{"a":"3000","ch":"1002","v":"5.0.4","e":"16189287264989141385216001","bc":"310100"}',
          'X-Host': 'mall.film-ticket.film.list'
        }
